...
export default function Navbar() {
    ...
    return (
        <>
            <nav className={`navbar  fixed top-0 left-0 w-full bg-base-100 px-4 shadow-md justify-between items-center z-50 transition-all duration-500 ${isSticky ? 'shadow-lg' : ''}`}>
                ...
                <div className="flex gap-2 items-center">
                    ...
                    <div className="dropdown dropdown-end">
                        ...
                        <ul tabIndex={0} className="dropdown-content z-[1] animate__animated animate__slideInDown menu p-2 shadow bg-base-100 rounded-box w-40">
